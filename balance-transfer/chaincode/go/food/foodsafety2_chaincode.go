...
func (t *SimpleChaincode) initLedger(stub shim.ChaincodeStubInterface) pb.Response {
	...
	//初始化质检员
	persons := []Person{
		Person{Personid: "FW00264", Name: "夏良军", Sex: "男", Workplace: "米业生产", Job: "监仓", Password: "123"},
		Person{Personid: "FW006133", Name: "徐炎浩", Sex: "男", Workplace: "福天下合作社", Job: "基地管理员", Password: "123"},
		Person{Personid: "FW006222", Name: "张道海", Sex: "男", Workplace: "福天下合作社", Job: "稻虾基地管理员", Password: "123"},
		Person{Personid: "FW00014", Name: "齐永新", Sex: "男", Workplace: "福天下合作社", Job: "技术员", Password: "123"},
		Person{Personid: "FW006232", Name: "杜宝元", Sex: "男", Workplace: "福天下合作社", Job: "稻虾基地管理员", Password: "123"},
		Person{Personid: "FW006281", Name: "张从仿", Sex: "男", Workplace: "福天下合作社", Job: "基地管理员", Password: "123"},
		Person{Personid: "FW00630", Name: "谢申华", Sex: "男", Workplace: "福天下合作社", Job: "工程部经理", Password: "123"},
		Person{Personid: "FW00656", Name: "谢星", Sex: "男", Workplace: "米业生产", Job: "技术员", Password: "123"},
		Person{Personid: "FW00702", Name: "谢均涛", Sex: "男", Workplace: "米业生产", Job: "原料保管", Password: "123"},
		Person{Personid: "FW00803", Name: "谢松才", Sex: "男", Workplace: "福天下合作社", Job: "基地管理员", Password: "123"},
		Person{Personid: "FW00001", Name: "aa", Sex: "女", Workplace: "米业生产", Job: "原料保管", Password: "123"},
		Person{Personid: "FW00002", Name: "bb", Sex: "女", Workplace: "福天下合作社", Job: "基地管理员", Password: "123"},
	}
	i := 0
	for i < len(persons) {
		fmt.Println("i is ", i)
	...
	drugs := []Drug{
		...
		Drug{Drugid: "FHCBJ0317021001", Name: "氟环唑", Dosage: "悬浮剂", Standard: "Q/SSCC101-2011", Effect: "杀菌", Personid: "FW"},
		Drug{Drugid: "KJJBJ0317020101", Name: "咯菌腈", Dosage: "悬浮剂", Standard: "Q/320583GQB", Effect: "杀菌", Personid: "FW"},
		Drug{Drugid: "MXABJ0317021801", Name: "咪鲜胺", Dosage: "水乳剂", Standard: "GB22625-2008", Effect: "杀菌", Personid: "FW"},
		Drug{Drugid: "XDJBJ0317012001", Name: "消毒剂", Dosage: "液态", Standard: "国标", Effect: "消毒", Personid: "FW"},
	}
	i = 0
	for i < len(drugs) {
		fmt.Println("i is ", i)
	...
	//初始化种子
	seeds := []Seed{
		Seed{Seedid: "JZ361JX0117020101", Variety: "江早361", Type: "早稻", Personid: "FW123"},
		Seed{Seedid: "TLY83HN0117020101", Variety: "潭两优83", Type: "早稻", Personid: "FW123"},
		Seed{Seedid: "ZJZ17ZJJ0217020101", Variety: "中嘉早17", Type: "早稻", Personid: "FW123"},
		Seed{Seedid: "ZLY171ZJ0217020101", Variety: "株两优171", Type: "早稻", Personid: "FW123"},
	}
	i = 0
	for i < len(seeds) {
		fmt.Println("i is ", i)
	...
	//初始化秧苗
	seedlings := []Seedling{
		Seedling{Seedlingid: "JZ361JX0117020101XDJBJ031701200117031401DP217031601", Nurseryplace: "2号大棚", Startdate: "2017-03-16", Personid: "FW123"},
		Seedling{Seedlingid: "TLY83HN0117020101XDJBJ031701200117031701HY17031901", Nurseryplace: "红阳育秧工厂", Startdate: "2017-03-19", Personid: "FW123"},
		Seedling{Seedlingid: "ZJZ17ZJJL0217020101XDJBJ031701200117031501DP117031701", Nurseryplace: "1号大棚", Startdate: "2017-03-17", Personid: "FW123"},
		Seedling{Seedlingid: "ZLY171ZJ0217020101XDJBJ031701200117031601HY17031801", Nurseryplace: "红阳育秧工厂", Startdate: "2017-03-18", Personid: "FW123"},
	}
	i = 0
	for i < len(seedlings) {
		fmt.Println("i is ", i)
	...
	seedsoakdrugs := []Seedsoakdrug{
		Seedsoakdrug{Seedid: "JZ361JX0117020101", Drugid: "XDJBJ0317012001", Concentration: "29.5", Startdate: "2017-03-14", Enddata: "2017-03-15", Personid: "FW123"},
		Seedsoakdrug{Seedid: "TLY83HN0117020101", Drugid: "XDJBJ0317012001", Concentration: "32", Startdate: "2017-03-17", Enddata: "2017-03-18", Personid: "FW123"},
		Seedsoakdrug{Seedid: "ZJZ17ZJJ0217020101", Drugid: "XDJBJ0317012001", Concentration: "30", Startdate: "2017-03-15", Enddata: "2017-03-16", Personid: "FW123"},
		Seedsoakdrug{Seedid: "ZLY171ZJ0217020101", Drugid: "XDJBJ0317012001", Concentration: "33", Startdate: "2017-03-16", Enddata: "2017-03-17", Personid: "FW123"},
	}
	i = 0
	...
	seedlingspraydrugs := []Seedlingspraydrug{
		Seedlingspraydrug{Seedlingid: "JZ361JX0117020101XDJBJ031701200117031401DP217031601", Drugid: "KJJBJ0317020101", Dosage: "20.5", Data: "2017-03-16", Personid: "FW123"},
		Seedlingspraydrug{Seedlingid: "TLY83HN0117020101XDJBJ031701200117031701HY17031901", Drugid: "KJJBJ0317020101", Dosage: "21", Data: "2017-03-19", Personid: "FW123"},
		Seedlingspraydrug{Seedlingid: "ZJZ17ZJJL0217020101XDJBJ031701200117031501DP117031701", Drugid: "KJJBJ0317020101", Dosage: "22", Data: "2017-03-17", Personid: "FW123"},
		Seedlingspraydrug{Seedlingid: "ZLY171ZJ0217020101XDJBJ031701200117031601HY17031801", Drugid: "KJJBJ0317020101", Dosage: "20.5", Data: "2017-03-18", Personid: "FW123"},
	}
	i = 0
	...
	//初始化种植
	plants := []Plant{
		Plant{Plantid: "NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401", Place: "1号农田", Startdate: "2017-04-04", Personid: "FW123"},
		Plant{Plantid: "NT2TLY83HN0117020101XDJBJ031701200117031701HY1703190117040501", Place: "2号农田", Startdate: "2017-04-05", Personid: "FW123"},
		Plant{Plantid: "NT3ZJZ17ZJJL0217020101XDJBJ031701200117031501DP11703170117040301", Place: "3号农田", Startdate: "2017-04-03", Personid: "FW123"},
		Plant{Plantid: "NT4JZ361JX0117020101XDJBJ031701200117031401DP21703160117040201", Place: "4号农田", Startdate: "2017-04-05", Personid: "FW123"},
	}
	i = 0
	for i < len(plants) {
		fmt.Println("i is ", i)
	...
	plantusedrugs := []Plantusedrug{
		Plantusedrug{Plantid: "NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401", Drugid: "CCJHB0317012501", Dosage: "9", Effect: "防治稻瘟、叶枯、纹枯", Date: "2017-06-18", Personid: "FW123"},
		Plantusedrug{Plantid: "NT2TLY83HN0117020101XDJBJ031701200117031701HY1703190117040501", Drugid: "CCJHB0317012501", Dosage: "8.7", Effect: "防治稻瘟、叶枯、纹枯", Date: "2017-06-18", Personid: "FW123"},
		Plantusedrug{Plantid: "NT3ZJZ17ZJJL0217020101XDJBJ031701200117031501DP11703170117040301", Drugid: "CCJHB0317012501", Dosage: "9", Effect: "防治稻瘟、叶枯、纹枯", Date: "2017-06-18", Personid: "FW123"},
		Plantusedrug{Plantid: "NT4JZ361JX0117020101XDJBJ031701200117031401DP21703160117040201", Drugid: "CCJHB0317012501", Dosage: "8.5", Effect: "防治稻瘟、叶枯、纹枯", Date: "2017-06-18", Personid: "FW123"},
	}
	i = 0
	...
	//初始化入库
	inputs := []Input{
		Input{Inputid: "NT12017072243990601", Harvestdate: "2017-07-22", Quantity: "439906", Inputdate: "2017-07-26", Personid: "FW123"},
		Input{Inputid: "NT22017072342178101", Harvestdate: "2017-07-23", Quantity: "421781", Inputdate: "2017-07-27", Personid: "FW123"},
		Input{Inputid: "NT32017072141156501", Harvestdate: "2017-07-21", Quantity: "411565", Inputdate: "2017-07-25", Personid: "FW123"},
		Input{Inputid: "NT4201707202627101", Harvestdate: "2017-07-20", Quantity: "26271", Inputdate: "2017-07-24", Personid: "FW123"},
	}
	i = 0
	for i < len(inputs) {
		fmt.Println("i is ", i)
	...
	warehouses := []Warehouse{
		Warehouse{Warehouseid: "CK5", Place: "湖北监利新沟银欣米业厂", Capacity: "9676", Standard: "标准", Personid: "FW123"},
		Warehouse{Warehouseid: "CK6", Place: "湖北监利新沟银欣米业厂", Capacity: "9370", Standard: "标准", Personid: "FW123"},
		Warehouse{Warehouseid: "CK7", Place: "湖北监利新沟银欣米业厂", Capacity: "8869", Standard: "标准", Personid: "FW123"},
		Warehouse{Warehouseid: "CK8", Place: "湖北监利新沟银欣米业厂", Capacity: "9641", Standard: "标准", Personid: "FW123"},
	}
	...
	warehouse2feeds := []Warehouse2feed{
		Warehouse2feed{Warehouseid: "CK5", Feedid: "CK5DMJG0117082801", Personid: "FW123"},
		Warehouse2feed{Warehouseid: "CK6", Feedid: "CK6DMJG0117082801", Personid: "FW123"},
		Warehouse2feed{Warehouseid: "CK7", Feedid: "CK7DMJG0117083001", Personid: "FW123"},
		Warehouse2feed{Warehouseid: "CK8", Feedid: "CK8DMJG0117083001", Personid: "FW123"},
	}
	i = 0
	...
	plant2inputs := []Plant2input{
		Plant2input{Plantid: "NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401", Inputid: "NT12017072243990601", Personid: "FW123"},
		Plant2input{Plantid: "NT2TLY83HN0117020101XDJBJ031701200117031701HY1703190117040501", Inputid: "NT22017072342178101", Personid: "FW123"},
		Plant2input{Plantid: "NT3ZJZ17ZJJL0217020101XDJBJ031701200117031501DP11703170117040301", Inputid: "NT32017072141156501", Personid: "FW123"},
		Plant2input{Plantid: "NT4JZ361JX0117020101XDJBJ031701200117031401DP21703160117040201", Inputid: "NT4201707202627101", Personid: "FW123"},
	}
	i = 0
	...
	input2warehouses := []Input2warehouse{
		Input2warehouse{Inputid: "NT12017072243990601", Warehouseid: "CK6", Personid: "FW123"},
		Input2warehouse{Inputid: "NT22017072342178101", Warehouseid: "CK7", Personid: "FW123"},
		Input2warehouse{Inputid: "NT22017072342178101", Warehouseid: "CK8", Personid: "FW123"},
		Input2warehouse{Inputid: "NT32017072141156501", Warehouseid: "CK6", Personid: "FW123"},
		Input2warehouse{Inputid: "NT4201707202627101", Warehouseid: "CK5", Personid: "FW123"},
	}
	i = 0
	...
	feed2products := []Feed2product{
		Feed2product{Feedid: "CK5DMJG0117082801", Productid: "JC1CMGUO01170828ZS01", Personid: "FW123"},
		Feed2product{Feedid: "CK6DMJG0117082801", Productid: "JC2CMGUO01170828HG01", Personid: "FW123"},
		Feed2product{Feedid: "CK7DMJG0117083001", Productid: "JC3CMS01170830ZM01", Personid: "FW123"},
		Feed2product{Feedid: "CK8DMJG0117083001", Productid: "JC4CMGEN01170830HZ01", Personid: "FW123"},
	}
	i = 0
	...
	//初始化进料管理
	feeds := []Feed{
		Feed{Feedid: "CK5DMJG0117082801", Weight: "169440", Watercontent: "14.5", Brokenrice: "3.5", Qingmilv: "2.5", Date: "2017-08-28", Personid: "FW123"},
		Feed{Feedid: "CK6DMJG0117082801", Weight: "97780", Watercontent: "14.1", Brokenrice: "2", Qingmilv: "3", Date: "2017-08-28", Personid: "FW123"},
		Feed{Feedid: "CK7DMJG0117083001", Weight: "203330", Watercontent: "14.1", Brokenrice: "2", Qingmilv: "3", Date: "2017-08-30", Personid: "FW123"},
		Feed{Feedid: "CK8DMJG0117083001", Weight: "92060", Watercontent: "14.5", Brokenrice: "3", Qingmilv: "2", Date: "2017-08-30", Personid: "FW123"},
	}
	i = 0
	for i < len(feeds) {
		fmt.Println("i is ", i)
	...
	//初始化原料
	materials := []Material{
		Material{Materialid: "BSTMS0517082201", Kind: "白砂糖", Weight: "10", Source: "四川眉山王五糖业", Date: "2017-08-22", Personid: "FW123"},
		Material{Materialid: "XMFSJZ0617082501", Kind: "小麦粉", Weight: "10", Source: "河北石家庄晋务粉业", Date: "2017-08-25", Personid: "FW123"},
		Material{Materialid: "ZLYMAS0417082001", Kind: "棕榈油", Weight: "10", Source: "安徽马鞍山金龙鱼有限公司", Date: "2017-08-20", Personid: "FW123"},
	}
	i = 0
	for i < len(materials) {
		fmt.Println("i is ", i)
	...
	//初始化产品
	products := []Product{
		Product{Productid: "JC1CMGUO01170828ZS01", Name: "糙米果", Specification: "芝士味", Flavor: "2kg*1", Date: "2017-08-28", Personid: "FW123"},
		Product{Productid: "JC2CMGUO01170828HG01", Name: "糙米果", Specification: "黄瓜味", Flavor: "2kg*1", Date: "2017-08-28", Personid: "FW123"},
		Product{Productid: "JC3CMS01170830ZM01", Name: "糙米酥", Specification: "芝麻味", Flavor: "32g*12*6", Date: "2017-08-30", Personid: "FW123"},
		Product{Productid: "JC4CMGEN01170830HZ01", Name: "糙米羹", Specification: "红枣味", Flavor: "360g*12", Date: "2017-08-30", Personid: "FW123"},
	}
	i = 0
	for i < len(products) {
		fmt.Println("i is ", i)
	...
	material2products := []Material2product{
		Material2product{Materialid: "ZLYMAS0417082001", Productid: "JC1CMGUO01170828ZS01", Personid: "FW123"},
		Material2product{Materialid: "XMFSJZ0617082501", Productid: "JC2CMGUO01170828HG01", Personid: "FW123"},
		Material2product{Materialid: "BSTMS0517082201", Productid: "JC3CMS01170830ZM01", Personid: "FW123"},
		Material2product{Materialid: "BSTMS0517082201", Productid: "JC4CMGEN01170830HZ01", Personid: "FW123"},
	}
	i = 0
	...
	seed2seedlings := []Seed2seedling{
		Seed2seedling{Seedid: "JZ361JX0117020101", Seedlingid: "JZ361JX0117020101XDJBJ031701200117031401DP217031601", Personid: "FW123"},
		Seed2seedling{Seedid: "TLY83HN0117020101", Seedlingid: "TLY83HN0117020101XDJBJ031701200117031701HY17031901", Personid: "FW123"},
		Seed2seedling{Seedid: "ZJZ17ZJJ0217020101", Seedlingid: "ZJZ17ZJJL0217020101XDJBJ031701200117031501DP117031701", Personid: "FW123"},
		Seed2seedling{Seedid: "ZLY171ZJ0217020101", Seedlingid: "ZLY171ZJ0217020101XDJBJ031701200117031601HY17031801", Personid: "FW123"},
	}
	i = 0
	...
	seedling2plants := []Seedling2plant{
		Seedling2plant{Seedlingid: "ZLY171ZJ0217020101XDJBJ031701200117031601HY17031801", Plantid: "NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401", Personid: "FW123"},
		Seedling2plant{Seedlingid: "TLY83HN0117020101XDJBJ031701200117031701HY17031901", Plantid: "NT2TLY83HN0117020101XDJBJ031701200117031701HY1703190117040501", Personid: "FW123"},
		Seedling2plant{Seedlingid: "ZJZ17ZJJL0217020101XDJBJ031701200117031501DP117031701", Plantid: "NT3ZJZ17ZJJL0217020101XDJBJ031701200117031501DP11703170117040301", Personid: "FW123"},
		Seedling2plant{Seedlingid: "JZ361JX0117020101XDJBJ031701200117031401DP217031601", Plantid: "NT4JZ361JX0117020101XDJBJ031701200117031401DP21703160117040201", Personid: "FW123"},
	}
	i = 0
...
func (t *SimpleChaincode) initSeedling(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var err error
	// 0  1          2      3
	// 'JZ361JX0117020101XDJBJ031701200117031401DP217031601', '2号大棚', '2017-03-16',  'FW001'
	if len(args) != 4 {
		return shim.Error("Incorrect number of arguments. Expecting 4")
	}
...
func (t *SimpleChaincode) initSeedsoakdrug(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4        5
	// 'JZ361JX0117020101', 'XDJBJ0317012001', '29.5', '2017-03-14', '2017-03-15', 'FW'
	if len(args) != 6 {
		return shim.Error("Incorrect number of arguments. Expecting 6")
	}
...
func (t *SimpleChaincode) initSeedlingspraydrug(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4
	// 'JZ361JX0117020101XDJBJ031701200117031401DP217031601', 'KJJBJ0317020101', '20.5', '2017-03-16', 'FW'
	if len(args) != 5 {
...
func (t *SimpleChaincode) initPlant(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3
	//  '('NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401', '1号农田', '2017-04-04', 'FW'
	if len(args) != 4 {
		return shim.Error("Incorrect number of arguments. Expecting 4")
	}
...
func (t *SimpleChaincode) initPlantusedrug(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4        5
	// ''NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401', 'CCJHB0317012501', '9', '防治稻瘟、叶枯、纹枯', '2017-06-18','FW'
	if len(args) != 6 {
		return shim.Error("Incorrect number of arguments. Expecting 6")
	}
...
func (t *SimpleChaincode) initInput(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	//   0           1       2     3                4
	//  'NT12017072243990601', '2017-07-22', 439906, '2017-07-26', 'FW"
	if len(args) != 5 {
		return shim.Error("Incorrect number of arguments. Expecting 5")
	}
...
func (t *SimpleChaincode) initPlant2input(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var err error
	// 0  1          2
	// 'NT1ZLY171ZJ0217020101XDJBJ031701200117031601HY1703180117040401', 'NT12017072243990601',  'FW001'
	if len(args) != 3 {
		return shim.Error("Incorrect number of arguments. Expecting 3")
	}
...
func (t *SimpleChaincode) initFeed2product(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2
	// ''CK5DMJG0117082801', 'JC1CMGUO01170828ZS01', 'FW'
	if len(args) != 3 {
		return shim.Error("Incorrect number of arguments. Expecting 3")
	}
...
func (t *SimpleChaincode) initFeed(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4        5     6
	// 'CK5DMJG0117082801', '169440', '14.5', '3.5', '2.5', '2017-08-28','FW'
	if len(args) != 7 {
...
func (t *SimpleChaincode) initMaterial(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4        5
	// 'BSTMS0517082201', '白砂糖', '10', '四川眉山王五糖业', '2017-08-22', 'FW'
	if len(args) != 6 {
		return shim.Error("Incorrect number of arguments. Expecting 6")
	}
...
func (t *SimpleChaincode) initProduct(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2      3     4         5
	// 'JC1CMGUO01170828ZS01', '糙米果', '芝士味', '2kg*1', '2017-08-28', 'FW'
	if len(args) != 6 {
		return shim.Error("Incorrect number of arguments. Expecting 6")
	}
...
func (t *SimpleChaincode) initMaterial2product(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// 0  1          2
	// ''ZLYMAS0417082001', 'JC1CMGUO01170828ZS01','FW'
	if len(args) != 3 {
		return shim.Error("Incorrect number of arguments. Expecting 3")
	}
